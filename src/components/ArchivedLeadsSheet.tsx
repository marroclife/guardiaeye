      ...
      <SheetTrigger asChild>
        ...
        >
          ...
          {archivedLeads.length > 0 && (
            <span className="ml-1 px-1.5 py-0.5 text-xs rounded bg-white/10">
              {archivedLeads.length}
            </span>
          )}
        </Button>
      </SheetTrigger>
      <SheetContent className="w-full sm:max-w-md glass-card border-l border-white/10 bg-black/95 backdrop-blur-xl overflow-y-auto">
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    ...
                    {lead.company && (
                      <p className="text-sm text-neon-cyan flex items-center gap-1 mt-1">
